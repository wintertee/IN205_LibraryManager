      ...
      <section class="content">
        ...
        <div class="row">
          <div class="container">
            ...
            <div class="row">
              <p>Êtes-vous sûr de vouloir supprimer le livre ${livre.titre} de ${livre.auteur} (code
                ${livre.isbn}) ?
              </p>
              <!-- TODO : compléter les trois informations ci-contre -->
              <form action="/LibraryManager/livre_delete" method="post" class="col s12">
                ...
                <div class="row center">
                  ...
                  <a class="btn waves-effect waves-light orange"
                    href="/LibraryManager/livre_details?id=${livre.id}">Annuler</a>
                  <!-- TODO : remplacer idDuLivre par l'id du livre -->
                </div>
              </form>
            </div>
