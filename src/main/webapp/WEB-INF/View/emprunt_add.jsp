                ...
                <div class="row">
                  <div class="input-field col s6">
                    <select id="idLivre" name="idLivre" class="browser-default">
                      ...
                      <c:if test="${!listDispo.isEmpty()}">
                        <c:forEach items="${listDispo}" var="livre">
                  ...
                  <div class="input-field col s6">
                    <select id="idMembre" name="idMembre" class="browser-default">
                      ...
                      <c:if test="${!listMembreEmpruntPossible.isEmpty()}">
                        <c:forEach items="${listMembreEmpruntPossible}" var="member">
